...
exports.default = (function (passport) {
    passport.use("box-jwt", new passport_jwt_1.Strategy(boxOptions, function (token, done) { return __awaiter(void 0, void 0, void 0, function () {
        var box, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, mongoDB_1.Box.findById(token.user.id)];
                case 1:
                    box = _a.sent();
                    if (box) {
    ...
    passport.use("login", new passport_local_1.Strategy({
        ...
        var user, valid, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, mongoDB_1.User.findOne({ email: email })];
                case 1:
                    user = _a.sent();
                    if (!user) {
